...
public class AES {
	...
	public void encrypt(CryptoTriplet<String, String, String> cryptoTriplet, int version) // Jeremiah
	{
		...
		String roundKey = "to be expaneded";
		expandKey();
	...
	public void decrypt(CryptoTriplet<String, String, String> cryptoTriplet, int version) // Jeremiah
	{
	...
	private void addRoundKey(byte[] state, String roundKey) { // Brice
	}
