...
public class AES {
	...
	public void encrypt(CryptoTriplet<String, String, String> cryptoTriplet, int version) // Jeremiah
	{
		...
		expandKey(cryptoTriplet.getKey().getBytes());	// TODO
	...
	private void addRoundKey(byte[] state, byte roundKey[]) { // Brice
